...
In practice, it revealed a deeper difficulty.
...
The first attempts were made internally using AI tools.

ChatGPT was used to experiment with possible modifications of the homepage layout.

Several variations were tested.
...
The process became difficult to maintain.

This experience highlighted a simple reality.
...
Because the issue remained unresolved, a freelancer was contacted.

The request was intentionally small:

modify the buttons on the homepage.

The first pull request introduced much larger changes than expected.
...
However, it moved the project away from its intended simplicity.
...
Together they create a significant cognitive load.

At the moment, the available mental space to navigate all of them is limited.

The blockage is therefore not only technical.
...
This time the instructions are extremely precise.
...
However, it introduces another constraint.
...
Several lessons appear from this experience.
